  ...
  return (
    <div className="  xl:px-60 bg-lightGrey flex py-10 lg:py-[80px]  center">
      <div className="center  flex-col bg-white py-8 md:py-[69px] mx-3 md:w-5/6 gap-8 rounded-lg  shadow-md">
        <h3 className=" text-[24px] md:text-4xl text-center md:text-left font-bold">Got <span className="text-orange">Questions</span>? We&apos;ve Got <span className="text-orange">Answers</span>!  </h3>
